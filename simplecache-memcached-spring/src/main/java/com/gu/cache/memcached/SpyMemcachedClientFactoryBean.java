...
public class SpyMemcachedClientFactoryBean extends AbstractFactoryBean<com.gu.cache.memcached.MemcachedClient> {
	...
	@Override
	protected com.gu.cache.memcached.MemcachedClient createInstance() throws Exception {
